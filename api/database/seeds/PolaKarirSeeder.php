...
class PolaKarirSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $syarat_jabatan_collection = [
            ...
            ['nama_syarat' => 'SYARAT JABATAN PENGAWAS (SETARA ESELON IV.a)','jenis_jabatan' => 'Fungsional','kode_jabatan' => '1','url_berkas' => '/syarat_jabatan/draf-1626842983.docx'],
            ['nama_syarat' => 'SYARAT JABATAN PENGAWAS (SETARA ESELON IV.b)','jenis_jabatan' => 'Fungsional','kode_jabatan' => '1','url_berkas' => '/syarat_jabatan/draf-1626842984.docx'],
